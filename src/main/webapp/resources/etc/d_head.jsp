...
<link rel="stylesheet" href="/resources/css/hf_collect/developer_menu.css" />
...
<!-- 프로젝트 심벌 -->
    ...
    <!-- 로고 -->
      <div class="logo">
		...
		<!-- 메뉴 -->
		<input type="checkbox" id="menuicon"> <label for="menuicon" style="margin-top:-135.5px; margin-right: -0.3px;">
