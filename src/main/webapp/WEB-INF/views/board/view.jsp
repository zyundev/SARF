   ...
   <br>
      ...
      <div class="top_btn" style="padding-bottom: 13px">
         <div class="left_area">
            ...
            <!-- 목록 -->
            <a href="/board/list" class="basebutton skin size">목록</a>
         </div>
         <div class="right_area">
            <!-- 수정 -->
            <a href="/board/modifyView?bno=${read.bno}" class="basebutton skin size">수정</a>
            <!-- 삭제 -->
            <a href="/board/deleteView" class="basebutton skin size">삭제</a>
         </div>
      </div>
   </div>
