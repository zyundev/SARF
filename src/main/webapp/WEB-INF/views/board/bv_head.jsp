...
<link rel="stylesheet" href="/resources/css/hf_collect/bview_menu.css" />
...
<!-- 프로젝트 심벌 -->
    ...
    <!-- 로고 -->
      <div class="logo">
		...
		<!-- 메뉴 -->
		<input type="checkbox" id="menuicon"> <label for="menuicon" style="margin-top:-126px; margin-right:34px;">
