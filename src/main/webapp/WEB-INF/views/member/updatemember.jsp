    ...
    <form onsubmit="return chk()" method="post" action="updatemember">
        <div class="container">
            ...
            <div class="container_name">
                <input class="container_name_input" type="text" name="name" value="${member.getName()}" maxlength="10">
            ...
            <div class="container_email">
                <input class="container_email_input" type="email" name="email" value="${member.getEmail()}" maxlength="40">
