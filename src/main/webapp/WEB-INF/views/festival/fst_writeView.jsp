...
<body>
   ...
   <div class="base-layout">
      ...
      <div class="WritingContent">
         <form class="writeForm" name="writeForm" method="post" action="/festival/write" enctype="multipart/form-data"> 
            <!-- 구역 구분 -->
            ...
            <!-- 내용 -->
            <textarea placeholder="내용을 입력해 주세요." id="content" name="content" style="resize: none; font-size: 15px; outline: none;" rows="22" cols="115"></textarea>
               <!-- SmartEditor2 -->
            ...
            <div style="border: 1px solid black;">
               <button type="button" class="BaseButton" onclick="location.href='/festival/list'">취소</button> 
