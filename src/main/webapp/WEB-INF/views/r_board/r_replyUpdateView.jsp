...
<script type="text/javascript">
	$(function(){
		...
		$(".cancel_btn").on("click", function(){
			location.href = "/r_board/r_view?bno=${r_replyUpdate.bno}";
			/*
				   + "&page=${scri.page}"
	...
	<div class="view_list">
		<div class="view_content">
			...
			<form name="updateForm" role="form" method="post" action="/board/replyUpdate">
				<input type="hidden" name="bno" value="${r_replyUpdate.bno}"/>
				<input type="hidden" id="rno" name="rno" value="${r_replyUpdate.rno}" />
				<!-- 
				...
				<input type="hidden" id="keyword" name="keyword" value="${scri.keyword}"> 
				 -->
				<textarea id="content" class="cmt_write_box" name="content">${r_replyUpdate.content}</textarea>
				<div>
