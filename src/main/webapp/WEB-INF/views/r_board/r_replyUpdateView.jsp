	...
	<div class="view_list">
		<div class="view_content">
			<div class="comment_box">
				<!-- 댓글 입력창-->
				<p
					style="float: left; margin-top: 3px; margin-right: 12px; font-size: 17px;">댓글
					수정</p>
				<form name="updateForm" role="form" method="post"
					action="/r_board/replyUpdate">
					<input type="hidden" name="bno" value="${replyUpdate.bno}" /> <input
						type="hidden" id="rno" name="rno" value="${replyUpdate.rno}" />
					<!-- 
