...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".cancel_btn").on("click", function() {
			...
			location.href = "/arf/a_list"; /* action 경로 수정 */
		})
	})
</script>
...
<body>
	<div class="base-layout">
		...
		<div class="UpdateContent">
			<form name="updateForm" role="form" method="post" action="/arf/a_update"> <!-- action 경로 수정 -->
				<div class="UpdateTitle">명소 게시판</div>
				<div>방향 : ${update.key}</div>
				<input type="hidden" name="bno" value="${update.num}" readonly="readonly" />
