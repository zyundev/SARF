          ...
          <div class="article">
             <div class="q"> 
               <div class="trigger"><b class="qfont">Q.</b>이곳은 무슨 사이트인가요?</div>
                ...
                <div class="a hidden">
                    <b class="afont">A.</b>
                     SARF는 서울 여행에 관심있는 모든 관광객을 위해 서울의 관광정보를 통합적으로 제공하는 서울시의 관광 사이트입니다. 관광명소/음식점/공연 등 서울의 다양한 관광정보와 함께 예약/예매, 여행상담, 커뮤니티 등 편리한 기능을 제공합니다.
                </div>
          </div>
          <div class="article">
             <div class="q">
               <div class="trigger"><b class="qfont">Q.</b>사이트에 있는 주요 정보는 무엇인가요?</div>
                ...
                <div class="a hidden">
                    <b class="afont">A.</b>
                     SARF는 서울 관광과 관련된 모든 정보를 제공합니다. 관광명소, 공연, 행사 음식점, 등에 관한 기본 정보는 물론, 추천코스, 관광지도, 홍보물 등 다양한 서울의 관광정보를 제공합니다.
                </div>
          </div>
          <div class="article">
             <div class="q">
               <div class="trigger"><b class="qfont">Q.</b>통합 검색은 어떤 서비스인가요?</div>
                ...
                <div class="a hidden">
                    <b class="afont">A.</b>
                     통합검색은 내가 원하는 정보를 손쉽게 찾아볼 수 있도록 SARF 에서 제공하는 기능입니다. 카테고리(명소, 음식점 등)카테고리별 검색결과를 확인할 수 있어 더욱 편리합니다.
                </div>
          </div>
          <div class="article">
             <div class="q">
