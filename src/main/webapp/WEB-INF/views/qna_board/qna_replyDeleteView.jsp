...
<script type="text/javascript">
	$(function(){
		...
		$(".cancel_btn").on("click", function(){
			location.href = "/qna_board/qna_readView?bno=${replyUpdate.bno}"
				   + "&page=${scri.page}"
	...
	<div class="view_list">
		<div class="view_content">
			<div class="comment_box">
				...
				<form name="updateForm" role="form" method="post" action="/qna_board/replyDelete">
					<input type="hidden" name="bno" value="${qna_replyDelete.bno}"/>
					<input type="hidden" id="rno" name="rno" value="${qna_replyDelete.rno}" />
					<!-- 
